## Module for concatenate output files
## Date : Decembre 2024
## Purpose: Conactenate several ouput files.


# -----------------
# statistics_simple
# -----------------
# - input {accession}/analyses/GENOME_RESULTS/candidates_simple_{{domain}}.txt : list of candidates with the domain
# - output GLOBAL_RESULTS + "simple_statistics_{domain}.csv" : list of candidates with the domain for all assemblies
...
rule select_wad:
    ...
    output:
        pathGTDriftData
            + "genome_assembly/{accession}/analyses/" + GENOME_RESULTS 
            + "whole_summary_selected.csv"         
    script:
        "../utils/python/candidate_selection.py"
