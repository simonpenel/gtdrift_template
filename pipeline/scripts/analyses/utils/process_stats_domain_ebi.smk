...
# ------------------------------------------
# The directory is located in genome_assembly_ebi/{accession}/analyses/
...
rule all:
    ...
    input:
        ...
        # -----------------------------------------------------------------------------
        # ON NE CALCULE PLUS CETTE SORTIE
        # candidates_wad_fasta=expand(pathGTDriftData
        #   + "genome_assembly_ebi/{accession}/analyses/" + GENOME_RESULTS
...
include: "../utils/module_stats_domain_ebi.smk"
include: "../utils/module_check_paralogs_ebi.smk"
include: "../utils/module_hmm.smk"
include: "../utils/module_concatenate_ebi.smk"
