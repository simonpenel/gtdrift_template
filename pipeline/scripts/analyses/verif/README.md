...
>[!TIP]
> The directories DOMAIN1 and DOMAIN2 in hmm_databases/ and the directory hmm_databases/ are empty at start, the contents will be generated by the pipeline.
